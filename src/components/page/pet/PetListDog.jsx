...
const PetListDog = () => {
    ...
    const loadData = async (sortingOrder) => {
        try {
            ...
            const response = await axios.get(`http://localhost:8080/api/v1/user/pets/${sortingOrder}`);
                    ...
                    <div className={PetListCSS['box1']} >
                        <div className={PetListCSS['navbar']}>
                            ...
                            <div className={PetListCSS['dropdown']}>
                                ...
                                <div className={PetListCSS['dropdown-content']}>
                                    <a href="#" onClick={() => handleSort("type_desc/Chó")} >Mới nhất</a>
                                    <a href="#" onClick={() => handleSort("type_asc/Chó")}>Cũ nhất</a>
