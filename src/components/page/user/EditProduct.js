...
export default function ProductUpForm() {
  ...
  const { product_name, price, description, date, phone, title, address } = product
          ...
          <div className={EditProduct['column']}>
            <div className={EditProduct['right-column']} >
              ...
              <div className={EditProduct['form-group']} >
                ...
                <input type="date" name='date' value={date} onChange={onInputChange} placeholder="Thời gian đăng" />
