import HomeCSS from '../../UI/Layout/Home.module.css'
import img1 from '../../../img/bg4.png'
...
<div>
    ...
    <Navbar/>
      <div className={HomeCSS["box_1"]}>
        <div>
          Welcome to Dog&Cat Platform
        </div>
      </div>
      <div className={HomeCSS["box_4"]}>
      ...
      <div className={HomeCSS["box_2"]}>
        <div>
        <span className={HomeCSS['box_span']}>Một số điều về loài chó có thể bạn chưa biết hoặc đã biết</span>
      ...
      <div className={HomeCSS["box_3"]}>
        <img src={img2} />
        <div>
        <span className={HomeCSS['box_span']}>Một số điều về loài mèo có thể bạn chưa biết hoặc đã biết</span>
      ...
      <a href='' className={HomeCSS['test']}>Nhấn vào đây để biết thêm nhiều điều thú vị hơn của hai anh bạn ở trên nào!</a>
