...
export default function Admin() {
  ...
  const loadUsers = async () => {
    const result = await axios.get("http://localhost:8080/api/v1/user/admin");
    ...
    <div className={AdminCss["container"]}>
      ...
      <div className={AdminCss["py-4"]}>
          ...
          <tbody>
            {currentData.map((user, index) => (
              <tr>
                ...
                <td>{user.birth}</td>
                <td>{user.sex}</td>
                <td className={AdminCss['btnbutton']}>
        ...
        {isDeleteModalOpen && ( // Render the modal if isDeleteModalOpen is true
          <div className={AdminCss["delete-modal"]}>
            <p>Bạn có chắc chắn muốn xóa?</p>
            <div  className={AdminCss["cancel-yes"]} >
      ...
      <div className={AdminCss['IntersectBox']}>
          <div className={AdminCss['box2']}>
