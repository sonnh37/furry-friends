...
import ProductPageCSS from './UI/ProductPage.module.css'
        ...
        <div className={ProductPageCSS['container2']} >
            ...
            <div className={ProductPageCSS['top-body1']}>
              ...
              <div className={ProductPageCSS['slider']} >
                ...
                <div className={ProductPageCSS['slider-content']} >
                  <div className={ProductPageCSS['slider-content-left']} >
                    <div className={ProductPageCSS['slider-content-left-top']}>
                      <a href=""><img src="" alt="" /></a>

                      <div className={ProductPageCSS['slider-content-left-top-btn']}>
          ...
          <div className={ProductPageCSS['box-body1']}>
            ...
            <div className={ProductPageCSS['listing-box']} >
              <a href="link1.html" className={ProductPageCSS['listing']} >
              ...
              <a href="link2.html" className={ProductPageCSS['listing']} >
                <div className={ProductPageCSS['post']} >
              ...
              <a href="link3.html" className={ProductPageCSS['listing']} >
                <div className={ProductPageCSS['post']} >
              ...
              <a href="link4.html" className={ProductPageCSS['listing']} >
                <div className={ProductPageCSS['post']} >
